...
**Day 1, May 24th**
	...
	* [Adam Morse (compositor.io): The past and future of designing interfaces](#adam) - *CSS*
	* [Marco Cedaro (Shazam, Kahoot, Crowdcube): Components, patterns and shit it’s hard to deal with](#marco) - *Patterns*
	* [Stefan Judis (Contentful): Watch your back, Browser! You're being observed. Browsers](#marco) - *APIs*
	* [Ally Long (freelancer): Field-tested interfaces for the next billion](#ally) - *UX*
	* [Niels Leenheer (HTML5Test.com): Monsters, mailboxes and other nonsense](#niels) - *IoT*

**Day 2, May 25th**
	* Patrick Hamann (Fastly, The Guardian, Financial Times): The First Meaningful Paint - *Performance*
	* Zoe Mickley Gillenwater (Booking.com): Experimenting your way to a better product - *A/B testing*
	* Vadim Makeev (HTML5Academy): I'm in IoT IoT, APIs - *Bluetooth & IoT*
	* Val Head (lynda.com, web design day conference): Motion In Design Systems: Animation, Style Guides, and the Design Process - *Animations*
	* Kirupa Chinnathambi (Microsoft, kirupa.com): Building a Progressive Web App - *PWAs*
	* Lin Clark (Mozilla): A Cartoon Intro to React Fiber - *React*
	* Jack Franklin (Songkick): The How, What and Why of migrating to ReactJS - *React*
	* Mihai Cernusca (Gifshop): Prevent Default — The future of authoring tools - *UX, mark-up, future of the web*

**Day 3, May 26th**
	* Konrad Dzwinel (Brainly, Google Developer Expert): Alternative Reality DevTools - *Devtools*
	* Martin Splitt (Archilogic):  Rendering performance inside out - *Performance*
	* Ida Aalen (freelancer): Easy and affordable user-testing - *UX, testing*
	* Ola Gasidło (Mozilla): Let's save the internet: How to make browsers compatible with the web - *Browsers*
	* Jenna Zeigen (Digital Ocean): On How Your Brain is Conspiring Against You Making Good Software - *Human factor*
	* Chris Wright (Campaign Monitor): Changing the layout game HTML - *CSS*
	* Rosie Campbel (BBC Technologist): Demystifying Deep Neural Networks - *Machine learning, Neural Networks*
	* Phil Hawksworth (R/GA): Microservices - The FAAS and the Furious - *Microservices*
<!-- ## Front Trends 2017
### May 24 - 26, Warsaw
